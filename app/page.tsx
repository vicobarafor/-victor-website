    ...
    <main className="min-h-screen bg-white text-black">
      <section className="border-b border-gray-200 bg-white">
        <div className="max-w-6xl mx-auto px-6 md:px-8 pt-20 pb-16">
          <div className="grid lg:grid-cols-[1.35fr_0.9fr] gap-14 items-center">
            <div className="max-w-4xl">
              ...
              <p className="text-xl md:text-2xl text-gray-800 font-medium mb-7 leading-relaxed max-w-3xl">
                Privacy-Preserving Machine Learning Researcher focused on
                federated learning, robust optimization, and research-grade
                machine learning systems.
              </p>

              <p className="text-base md:text-lg text-gray-700 leading-8 mb-10 max-w-3xl">
                I work on privacy-preserving machine learning, federated
                learning, and reproducible ML systems. My research focuses on
            ...
            <div className="grid gap-4">
              ...
              <div className="rounded-2xl border border-gray-200 p-5 bg-white shadow-sm">
                ...
                <p className="text-gray-700 leading-7">
                  ...
                  signals from client updates to improve stability and robustness.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-gray-200 p-5 bg-white shadow-sm">
                ...
                <p className="text-gray-700 leading-7">
                  ...
                  publication-standard outputs, faster iteration, and technically
                  disciplined research execution.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6">
            ...
            <article className="rounded-2xl border border-gray-200 bg-white p-7 shadow-sm hover:shadow-lg transition duration-200">
              ...
              <p className="text-gray-700 leading-8">
                ...
                the consensus direction, providing an interpretable mechanism
                for more robust federated aggregation.
              </p>
            </article>
